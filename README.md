...
![Extended Scanners Settings](imm/7.png)
...
![Extended Scanners Settings](imm/8.png)
...
### v1.8
- **Launch Frequency Anomaly Detection** - New risk analysis for aggressive persistence patterns:
  - Micro-Restart detection (StartInterval < 60 seconds)
...
- **Timeline Visualization** - Graphical representation of item lifecycle events (Created, Modified, Executed, Discovered)
- **Graph View Enhancements** - Improved node detail panel with mini radar chart, risk gauge, and risk factors breakdown
- **Statistics Dashboard** - New dedicated window with comprehensive metrics and charts accessible from toolbar
- **Sidebar Charts** - Compact visualizations integrated into the main sidebar for quick overview
